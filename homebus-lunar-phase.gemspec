...
require_relative 'lib/homebus-lunar-phase/version'

Gem::Specification.new do |spec|
  spec.name = 'homebus-lunar-phase'
  spec.version = HomebusLunarPhase::VERSION
  ...
  spec.homepage = 'https://github.com/HomeBusProjects/homebus-lunar-phase'
  spec.license = 'MIT'
  spec.required_ruby_version = ">= #{File.read('.ruby-version')}"

  spec.metadata['homepage_uri'] = spec.homepage
  spec.metadata['source_code_uri'] = 'https://github.com/HomeBusProjects/homebus-lunar-phase'
